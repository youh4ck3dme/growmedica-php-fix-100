            ...
            <div class="row">
                ...
                <div id="right-column" class="col-lg-9 col-md-9 col-sm-9 col-xs-12 col-vs-12">
                    ...
                    <div id="detail" class="row">
                        <div id="product-detail-gallery" class="col-lg-4 col-md-4 col-sm-4 col-xs-4 col-xs-offset-0 col-vs-10 col-vs-offset-1">
                            <div class="item">
                            ...
                            if (count($photogallery) > 0) {
                                ...
                                if (!empty($photogallery)) {
                                    foreach ($photogallery as $gallery_image) {
                                        ?>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 col-vs-6 no-gutter">
                                            <div class="item">
                        ...
                        <div id="product-detail-description" class="col-lg-8 col-md-8 col-sm-8 col-xs-8 col-vs-12">
                            <?
                            ...
                            <form method="post" class="product" style="overflow: hidden">
                                <div>
                                    ...
                                    */
                                    ?>
                                    <div id="price-container" class="col-md-6 no-gutter">
                                        <?
                                    ...
                                    <div id="purchase-container" class="col-md-6 no-gutter">                                        
                            ...
                            <div class="product-description-content default-text">
                                <?= $product->description; ?>
                            </div>
                        </div>                        
                    </div>
