...
export const metadata: Metadata = {
  title: 'Doprava a platba | Grow Medical',
}
    ...
    <div className="py-12 lg:py-20 bg-(--color-bg) min-h-screen">
      <Container>
        <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-(--shadow-card) border border-(--color-border)">
          <h1 className="text-3xl font-bold text-(--color-primary) mb-8 font-montserrat">Doprava a platba</h1>
          ...
          <div className="space-y-12 text-(--color-text-muted)">
            <section>
              ...
              <p className="mt-4 text-sm bg-green-50 text-green-800 p-3 rounded-lg">Pri nákupe nad 50 € máte akúkoľvek dopravu úplne ZADARMO!</p>
            </section>
            ...
            <section>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <div className="h-6 w-6 rounded bg-(--color-accent-green) text-white flex items-center justify-center mr-4 mt-0.5">✓</div>
                  <div>
