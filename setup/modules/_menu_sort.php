...
if (is_array($_POST['items'])) {
    ...
    foreach ($_POST['items'] as $key => $val) {
        $queryString = "update " . TABLE_PREFIX . "menu set sorter = '" . $i . "' where 1 and menu_id = '" . $val . "' and child_of = '" . $_GET['child_of'] . "';";
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Zoradenie položiek menu</title>
                ...
                <tr>
                    <td rowspan="2">
                        <select name="items[]" size="10" multiple="multiple" id="items[]" style="width: 98%;">
                            <?php
                            $queryString = "select menu_id as id, " . strtolower($_SESSION['lang']) . "_name as name from " . TABLE_PREFIX . "menu where 1 and child_of = '" . $_GET['child_of'] . "' order by sorter;";
                            if (!$Result = mysql_query($queryString)) {
